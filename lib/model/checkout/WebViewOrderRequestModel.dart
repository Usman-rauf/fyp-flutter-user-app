...
class WebViewOrderRequestModel {
  ...
  WebViewOrderRequestModel({this.setPaid, this.status, this.lineItems, this.shipping, this.billing, this.customerId, this.paymentMethod, this.transactionId, this.shippingLines});

  WebViewOrderRequestModel.fromJson(Map<String, dynamic> json) {
