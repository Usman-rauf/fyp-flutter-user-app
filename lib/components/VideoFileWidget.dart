                ...
                ? Container(
                    ...
                    child: Stack(
                      ...
                      children: <Widget>[
                          ...
                          children: <Widget>[
                            Row(
                              ...
                              children: <Widget>[
                                ...
                                IconButton(
                                  icon: Icon(isFullScreen ? Icons.fullscreen_exit : Icons.fullscreen,color: context.iconColor),
                                  onPressed: () {
                                    isFullScreen
                        ...
                        IconButton(
                          icon: Icon(controller.value.isPlaying ? Icons.pause : Icons.play_arrow, color:context.iconColor, size: 56.0),
                          onPressed: () {
